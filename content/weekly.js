...
const data = [
    weekly24,
    {
        ...
        items: [{
            ...
            description:"A very well written Book and great re-introduction to JS/programming fundamentals.",
            link:"https://eloquentjavascript.net/",
            image:"https://eloquentjavascript.net/img/cover.jpg",
        },{
            title:"BlurHash",
            description:"A cool way of showing a nice placeholder for an image while it's loading.",
            ...
            title:"Kanmail",
            description:"An email client that functions like a kanban board, for Mac/Windows/Linux/Docker.",
            link:"https://github.com/Oxygem/Kanmail",
            image:"https://raw.githubusercontent.com/Oxygem/Kanmail/master/screenshot.png",
        },{
            title:"next-dark-mode",
            description:"A package for enabeling dark mode in Next.js apps.",
            link:"https://github.com/xeoneux/next-dark-mode",
            image:"/weekly/screenshots/next-dark-mode.jpg",
        },{
            title:"react-see-through",
            description:"Draw attention to the important parts of your website with this react package.",
            link:"https://github.com/andrew4699/react-see-through",
            image:"https://raw.githubusercontent.com/andrew4699/react-see-through/master/example.png",
        },{
            ...
            image:"https://dev-to-uploads.s3.amazonaws.com/i/y575g6eyce1nwpq3wy5p.png",
        },{
            title:"pattern.css",
            description:'A CSS only library to fill your empty background with beautiful patterns.',
            link:"https://bansal.io/pattern-css",
            image:"https://bansal.io/assets/images/pattern-css-preview.jpg",
        },{
            title:"98.css",
            description:"A  CSS library for building interfaces that look like Windows 98.",
            link:"https://jdan.github.io/98.css/",
            image:"https://github.com/jdan/98.css/raw/master/docs/window.png?raw=true",
        },{
            title:"CSS.gg",
            description:"A list of Icons, which just released their second version.",
            link:"https://css.gg/",
    ...
    },
    {
        ...
        items: [{
            ...
            description:"GitHub just made all of the core features free for everyone. Here's their blog post announcing it.",
            link:"https://github.blog/2020-04-14-github-is-now-free-for-teams/",
            ...
            title:"BEM Cheat Sheet",
            description:"A nice cheat sheet for all of you who are using BEM for naming their CSS classes.",
            link:"https://9elements.com/bem-cheat-sheet/",
            image:"https://9elements.com/bem-cheat-sheet/src/img/bem-cheat-sheet.png",
        },{
            title:"Crank.js",
            description:"A new JS framework for writing JSX-driven components with functions, promises and generators.",
            link:"https://crank.js.org/",
            image:"/weekly/screenshots/crankjs.jpg",
        },{
            title:"Image compare viewer",
            description:"A vanilla JS library for adding a before and after compare slider to images.",
            link:"https://image-compare-viewer.netlify.app/",
            image:"/weekly/screenshots/imagecompareviewer.jpg",
        },{
            title:"Meanderer.js",
            description:"A JavaScript micro-library for responsive CSS motion paths",
            link:"https://meanderer.netlify.app/",
            image:"/weekly/screenshots/meanderer.jpg",
        },{
            title:"Vue.js v3.0-beta",
            description:"The new Vue.js version 3.0 is going beta. Check their blog post for more information.",
            link:"https://news.vuejs.org/issues/179",
            image:"https://news.vuejs.org/logo.png",
        },{
            title:"AHA Programming",
            description:'AHA stands for "Avoid Hasty Abstraction" and is a design principle by Kent C. Dodds. It deals with problems caused by the DRY principle.',
            link:"https://kentcdodds.com/blog/aha-programming",
            image:"https://kentcdodds.com/static/7fa12e9387c0fc00c2ec7b8444d5cf91/3e561/banner.jpg",
        },{
            title:"React landing page template",
            description:"A free React landing page template for creating quick landing pages.",
            link:"https://github.com/cruip/open-react-template",
            image:"https://user-images.githubusercontent.com/2683512/78789364-545e7100-79ad-11ea-9e3c-9528c99cda8e.png",
        },{
            title:"Stripe Connect: behind the front-end experience",
            description:"A blog post by Benjamin De Cock about the front-end design of Stripe's Connect.",
            link:"https://stripe.com/de/blog/connect-front-end-experience",
            image:"https://b.stripecdn.com/site-srv/assets/img/blog/posts/connect-frontend/header-background-fca7c86a3378d48e2f3bf0ccda9e7fbfa2bebe96.png",
        },{
            title:"Splitlist",
            description:"A website to create, share and collaborate on to-do lists, shopping lists and more.",
            link:"https://splitlist.mikkelsvartveit.com/",
            image:"/weekly/screenshots/splitlist.jpg",
        },{
            title:"Mock Service Worker",
            description:"A client-side API mocking library that intercepts outgoing requests using Service Workers.",
            link:"https://github.com/open-draft/msw",
            image:"https://raw.githubusercontent.com/open-draft/msw/master/logo.png",
        }]
    },
    {
        id: '21',
        ...
        items: [{
            ...
            description:"A four hour youtube course about bringing animation to your websites with CSS animations.",
            link:"https://www.youtube.com/playlist?list=PLHKH6Uj0Seea4gnA8A80PvW9XAQkT37bD",
            image:"/weekly/screenshots/level-up-css-animation.jpg",
        },{
            title:"Snapfont",
            description:"A browser extension to test fonts directly on your website.",
            link:"https://getsnapfont.com/",
            image:"https://getsnapfont.com/favicons/fb-cover.png",
        },{
            title:"Linkdash",
            ...
            image:"https://29comwzoq712ml5vj5gf479x-wpengine.netdna-ssl.com/wp-content/uploads/2020/03/summary.png",
        },{
            title:"multicopy",
            description:"A VS Code extension that lets you copy and paste multiple snippets of code in your workspace.",
            link:"https://github.com/adoi/multicopy",
            image:"https://raw.githubusercontent.com/adoi/multicopy/master/media/gifmulticopy.gif?token=AFTRRNUSNKFCK7WFPKB5GHC6TI4OW",
        },{
            title:"React Summit - Remote Edition 2020",
            description:"The remote version of the React Summit conference this friday is offering free tickets.",
            link:"https://remote.reactsummit.com/",
            image:"https://remote.reactsummit.com/img/og-v1.png",
        },{
            title:"themer",
            description:"Generate matching color themes for your terminal, IDE, slack and other applications.",
            link:"https://themer.dev/",
            image:"https://camo.githubusercontent.com/60f4572ed0826f0aed765af64f09bdd1ba9bfe28/68747470733a2f2f63646e2e6a7364656c6976722e6e65742f67682f6d6a7377656e73656e2f7468656d657240346537386239613530613030626162373630356234393936653432386239613663346130303062302f6173736574732f69636f6e2e706e67",
        },{
            title:"Winddown",
            description:"A VS Code extension, which reminds you to take a break by slowly fading out the colors.",
            link:"https://github.com/schneefux/vscode-winddown",
            image:"https://raw.githubusercontent.com/schneefux/vscode-winddown/master/demo.gif",
        },{
            title:"Rapid Image Layers Animation",
            description:"A rapid animation of multiple layers of images for intros or page transitions.",
            link:"https://tympanus.net/Development/RapidLayersAnimation/",
            image:"https://codropspz-tympanus.netdna-ssl.com/codrops/wp-content/uploads/2020/04/RapidLayerAnimation_featured.jpg",
        },{
            title:"Wireframer Font",
            description:"An open source typeface made of purposely redacted letters, which is presenting content as abstract bars.",
            link:"https://wireframer.design/",
            image:"https://wireframer.design/static/images/social-share.png",
        },{
            title:"hCaptcha",
            description:"A privacy friendly alternative to Googles reCaptcha.",
            link:"https://www.hcaptcha.com/",
            image:"https://assets.website-files.com/5c73e7ea3f8bb2a85d2781db/5c7d3345314d16473adbe413_funny%20robots%20stopped_1.svg",
        },{
            title:"<css-doodle />",
            description:"A web component for drawing patterns with CSS",
            link:"https://css-doodle.com/",
            image:"/weekly/screenshots/css-doodle.jpg",
        }]
    },
    {
        id: '20',
    ...
    },
    {
        ...
        items: [{
            ...
            title:"Puddle.js",
            description:"A fluid simulation library based on ASCII/Node and built using vanilla JS and CSS Grids.",
            link:"https://batman-nair.github.io/puddle.js/",
            ...
            title:"Motion Layout",
            description:"A react library, which helps you link components together to animate them when changing views.",
            link:"https://motion-layout.azurewebsites.net/",
            image:"/weekly/screenshots/reactmotionlayout.jpg",
        },{
            title:"vincent",
            description:"An app, which shows the latest design and frontend news.",
            link:"https://www.vincentapp.io/",
            image:"https://www.vincentapp.io/vincent-test-fs8.dcb82a6f.png",
        },{
            title:"Video Puppet",
            description:"A tool to generate videos from markdown files.",
            link:"https://www.videopuppet.com/docs/script/",
            image:"https://www.videopuppet.com/assets/2/script-img.png",
        },{
            title:"Animated Custom Cursor Effects",
            description:"Some demos for interactive custom cursor animations using SVG filters by Codrops.",
            link:"https://tympanus.net/Development/AnimatedCustomCursor/",
            image:"https://codropspz-tympanus.netdna-ssl.com/codrops/wp-content/uploads/2020/03/AnimatedCursor_featured-1.jpg",
        },{
            title:"SpicyPass",
            description:"A light-weight password manager with a focus on simplicity and security.",
            link:"https://github.com/JFreegman/SpicyPass",
            image:"https://camo.githubusercontent.com/7ab8ba6276b1051d12cfeaeaf20031e5eae5e731/68747470733a2f2f692e696d6775722e636f6d2f4c37657a454a642e706e67",
        },{
            title:"colors.lol",
            description:"A collection of overly descriptive color palettes.",
            link:"https://colors.lol/",
            image:"https://www.colors.lol/assets/images/colors.jpg",
        },{
            title:"Prettier 2.0 “2020”",
            description:"The release notes for the most recent prettier release.",
            link:"https://prettier.io/blog/2020/03/21/2.0.0.html",
            ...
            image:"https://res.cloudinary.com/wwebdev/image/upload/v1585478579/resources/css-separator-generator_gsgzyp.png",
    ...
    },
    {
        ...
        items: [{
            ...
            image:"/weekly/screenshots/colormixer.jpg",
        },{
            title:"Animated Hamburger Icons",
            description:"A nice React library for animated hamburger menus.",
            link:"https://hamburger-react.netlify.com/",
            image:"https://hamburger-react.netlify.com/hamburger-react.jpg",
        },{
            title:"TypeScript Particles",
            description:"A lightweight TypeScript library for creating particles by Matteo Bruni.",
            link:"https://particles.matteobruni.it/#virus",
            image:"https://particles.matteobruni.it/images/demo.png",
        },{
            title:"How to Build HTML Forms Right: Semantics",
            description:"The start of a series of articles about getting HTML Forms right.",
            link:"https://stegosource.com/how-to-build-html-forms-right-semantics/",
            image:"https://cdn.statically.io/img/stegosource.com/wp-content/uploads/html-blog-cover.svg",
        },{
            ...
            title:"CI/CD - Serverless Ebook",
            description:"A tutorial on how to publish eBooks with Gitbook CLI, Github Pages, Github Actions CI/CD, and Calibre.",
            link:"https://devops.novalagung.com/en/cicd-serverless-ebook-gitbook-github-pages-actions-calibre.html",
            image:"/weekly/screenshots/serverlessEbook.jpg",
        },{
            title:"Tabler Icons",
            description:"A set of over 300 free MIT-licensed high-quality SVG icons for you to use in your web projects.",
            link:"https://github.com/tabler/tabler-icons",
            image:"https://raw.githubusercontent.com/tabler/tabler-icons/master/.github/icons.png",
        },{
            title:"How to animate CSS and SVG's with AnimeJS",
            description:"An article about working with SVG's and CSS in AnimeJS.",
            link:"https://developerbacon.ca/articles/how-to-animate-css-and-svg-s-with-anime-js",
            image:"https://developerbacon.ca/assets/static/how-to-css-svg-animejs.c1fbd9b.e72c41f9af146eb2215c4e1f0bf6bd73.jpeg",
        },{
            title:"Awesome Javascript",
            description:"A big list of Blogs, Books, People, Podcasts, Conferences, NewsLetters, Videos and Documentaries about JS.",
            link:"https://dev.to/datastructures/awesome-javascript-best-blogs-books-people-podcasts-conferences-newsletters-videos-and-documentaries-on-the-web-updated-3ank",
            image:"https://res.cloudinary.com/practicaldev/image/fetch/s--jwvW0E3E--/c_imagga_scale,f_auto,fl_progressive,h_420,q_auto,w_1000/https://res.cloudinary.com/practicaldev/image/fetch/s--5u_yibg8--/c_imagga_scale%2Cf_auto%2Cfl_progressive%2Ch_420%2Cq_auto%2Cw_1000/https://dev-to-uploads.s3.amazonaws.com/i/fakmhzmgu7hmz0qzgb6n.png",
        }]
    },
    {
        id: '17',
    ...
    },
    {
        ...
        items: [{
            ...
            description:"A nice article by Stephen Hartfield about the gotchas in interview questions about JavaScript.",
            link:"https://alligator.io/js/gotchas/",
            image:"https://alligator.io/images/js/gotchas.png",
        },{
            ...
            link:"https://grep.app/",
            image:"/weekly/screenshots/grepapp.png",
        },{
            title:"Avant Sans",
            description:"A variable typeface by Meloyski.",
            link:"http://www.avantsans.meloyski.com/",
            image:"/weekly/screenshots/avantsans.jpg",
        },{
            title:"7 Ways To Make Sure Your Website is ADA Compliant",
            description:"An article by Carol Sankar about the things you can do to make your website accessible.",
            link:"https://www.inc.com/carol-sankar/7-ways-to-make-sure-your-website-is-ada-compliant.html",
            image:"https://www.incimages.com/uploaded_files/image/970x450/GettyImages-1149452893_412981.jpg",
        },{
            title:"DesignValley",
            description:"A big tool depository for things all around design.",
    ...
    },
    {
        ...
        items: [{
            ...
            link:"https://ocs.now.sh/",
            image:"https://ocs.now.sh/page/logo.jpg",
        },{
            title:"Neumorphism",
            description:"A CSS Code generator for Soft-UI code.",
            link:"https://neumorphism.io/",
            image:"https://neumorphism.io/ogImage.png",
        },{
            title:"Bit",
            description:"Bit helps to share reusable components between different projects and applications.",
            link:"https://bit.dev/",
            image:"https://static.bit.dev/og-images/bit-og-img-facebook.png",
        },{
            title:"DarkModeJS",
            description:"A simple plugin, which helps to add a darkmode to your website.",
            link:"https://nickdeny.github.io/darkmode-js/",
            image:"/weekly/screenshots/darkmodejs.png",
        },{
            title:"Full Stack Open 2019",
            description:"An open online course by University of Helsinki on modern web development with Javascript.",
            link:"https://fullstackopen.com/en/",
            image:"https://fullstackopen.com/static/EYE_green_wide-0a72f74a959f54d0f3e4bb8c67f6f158.jpg",
        },{
            title:"Learn CSS Positioning",
            description:"A cool interactive article by Ahmad Shadeed about how positioning works in CSS.",
            link:"https://ishadeed.com/article/learn-css-positioning/",
            image:"https://ishadeed.com/assets/css-pos/img/thumb.jpg",
        },{
            title:"UI/UX Design Trends for 2020",
            description:"A list of twenty design trends, which might become more relevant in 2020.",
            link:"https://shakuro.com/blog/ui-ux-design-trends-for-2020",
            image:"https://blog.shakuro.com/wp-content/uploads/2019/12/ui_ux_trends_2020_.jpg",
        },{
            title:"ScrollProgressBar",
            description:"A lightweigt library for adding a scrollbar, which displays how far an user has scrolled.",
            link:"https://scrollprogressbar.github.io/",
            image:"/weekly/screenshots/scrollprogressbar.png",
        },{
            title:"Toggle dark/light theme based on your user's preferred scheme",
            description:"An article about how to switch between the dark and the light theme based on the users preference.",
            link:"https://gosink.in/javascript-css-toggle-dark-light-theme-based-on-your-users-preferred-scheme/",
            image:"https://gosink.in/content/images/size/w2000/2020/02/toggle-theme.jpg",
        }],
    },
    {
        id: '11',
