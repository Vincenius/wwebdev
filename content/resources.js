const data = [
    {
        ...
        description: "A Cheatsheet to quickly find all functions that can be executed on a JavaScript Array. It includes a quick explanaition, the syntax, an example, and the browser support.",
