      ...
      { previewImage &&
        <a href={link}>
          ...
          <LazyLoad offsetVertical={1000}>
            <picture>
              <source srcset={`https://ik.imagekit.io/wwebdev/tr:w-380/${previewImage}`} media="(max-width: 380px)" />
              <S.PreviewImage src={`https://ik.imagekit.io/wwebdev/${previewImage}`} alt={headline} />
            </picture>
          </LazyLoad>
        </a>
      }
